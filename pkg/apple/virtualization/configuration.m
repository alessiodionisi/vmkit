...
void VZVirtualMachineConfiguration_setBootLoader(void *ptr, void *bootLoader) {
  [(VZVirtualMachineConfiguration *)ptr setBootLoader:(VZLinuxBootLoader *)bootLoader];
}
...
bool VZVirtualMachineConfiguration_validateWithError(void *ptr, void **error) {
  return [(VZVirtualMachineConfiguration *)ptr validateWithError:(NSError * _Nullable * _Nullable)error];
}

void VZVirtualMachineConfiguration_setSerialPorts(void *ptr, void *serialPorts) {
	[(VZVirtualMachineConfiguration *)ptr setSerialPorts:[(NSMutableArray *)serialPorts copy]];
}

void VZVirtualMachineConfiguration_setStorageDevices(void *ptr, void *storageDevices) {
	[(VZVirtualMachineConfiguration *)ptr setStorageDevices:[(NSMutableArray *)storageDevices copy]];
}

void VZVirtualMachineConfiguration_setNetworkDevices(void *ptr, void *networkDevices) {
	[(VZVirtualMachineConfiguration *)ptr setNetworkDevices:[(NSMutableArray *)networkDevices copy]];
}
